...
*
*                                   PORT FOR THE ATMEL AT91SAM9261
*
...
#define  PIOC_BASE              ((CPU_INT32U)0xFFFFF800)
...
#define  PIOC_PDR           (*(volatile CPU_INT32U *)(PIOC_BASE + 0x0004))
#define  PIOC_ASR           (*(volatile CPU_INT32U *)(PIOC_BASE + 0x0070))
#define  PIOC_BSR           (*(volatile CPU_INT32U *)(PIOC_BASE + 0x0074))
...
void  ProbeRS232_InitTarget (CPU_INT32U baud_rate)
{
    ...
    mclk_freq               = BSP_CPU_MclkFreq();               /* Calculate MCLK frequency                                 */
                                                                ...
                                                                /* ------------------ CONFIGURE US0 I/Os ------------------ */
                                                                /* Set GPIOC pins 8, 9, 10, & 11 as US0 pins              */
    PIOC_PDR              = DEF_BIT_08 | DEF_BIT_09 | DEF_BIT_10 | DEF_BIT_11;
    PIOC_ASR              = DEF_BIT_08 | DEF_BIT_09 | DEF_BIT_10 | DEF_BIT_11;
    ...
    PMC_PCER              = (1 << AT91C_ID_US0);                /* Enable the US0 peripheral clock                          */
                                                                ...
                                                                /* ------------------ CONFIGURE US1 I/Os ------------------ */
                                                                /* Set GPIOC pins 12 & 13 as US1 pins                       */
    PIOC_PDR              = DEF_BIT_12 | DEF_BIT_13;
    PIOC_ASR              = DEF_BIT_12 | DEF_BIT_13;
    ...
    PMC_PCER              = (1 << AT91C_ID_US1);                /* Enable the US1 peripheral clock                          */
                                                                ...
                                                                /* ------------------ CONFIGURE US1 I/Os ------------------ */
                                                                /* Set GPIOC pins 14 & 15 as US2 pins                       */
    PIOC_PDR              = DEF_BIT_14 | DEF_BIT_15;
    PIOC_ASR              = DEF_BIT_14 | DEF_BIT_15;
