...
void  ProbeRS232_InitTarget (CPU_INT32U  baud_rate)
{
    ...
    div       =   bus_freq / (16 * baud_rate);                          /* Compute the baud rate divider                            */
...
* Caller(s)   : This is an ISR.
*
* Note(s)     : (1) The receive and transmit interrupts are cleared by reading the status register
*                   and then either reading from or writing to the SCI data register.
*
*               (2) The vector table should use ProbeRS232_RxTxISR() (See probe_rs232_nba.s)
