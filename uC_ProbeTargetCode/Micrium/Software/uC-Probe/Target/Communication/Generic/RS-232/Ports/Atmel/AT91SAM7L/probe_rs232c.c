...
#define  AT91SAM7L_DRXD                     DEF_BIT_16
#define  AT91SAM7L_DTXD                     DEF_BIT_17
...
*/
  ...
  #error  "                                  [MUST be PROBE_RS232_UART_DBG ]   "

#elif     (PROBE_RS232_CFG_COMM_SEL != PROBE_RS232_UART_DBG)
...
void  ProbeRS232_InitTarget (CPU_INT32U baud_rate)
{
    ...
    pclk_freq             = BSP_CPU_ClkFreq();                  /* Calculate PCLK frequency                                 */
                                                                ...
                                                                /* ----------------- CONFIGURE DBGU I/Os ------------------ */
                                                                /* Set GPIOC pins 16 & 17 as DBGU pins                       */
    PIOC_PDR  = AT91SAM7L_DRXD | AT91SAM7L_DTXD;
    PIOC_ASR  = AT91SAM7L_DRXD | AT91SAM7L_DTXD;
    ...
    DBGU_BRGR = (CPU_INT16U)(((pclk_freq) / baud_rate / 16) - 1);
