...
*
*                                   PORT FOR THE ATMEL AT91SAM9263
*
...
#define  US0_BASE               ((CPU_INT32U)0xFFF8C000)
#define  US1_BASE               ((CPU_INT32U)0xFFF90000)
#define  US2_BASE               ((CPU_INT32U)0xFFF94000)
#define  DBGU_BASE              ((CPU_INT32U)0xFFFFEE00)
#define  AIC_BASE               ((CPU_INT32U)0xFFFFF000)
#define  PIOA_BASE              ((CPU_INT32U)0xFFFFF200)
#define  PIOC_BASE              ((CPU_INT32U)0xFFFFF600)
#define  PIOD_BASE              ((CPU_INT32U)0xFFFFF800)
#define  PMC_BASE               ((CPU_INT32U)0xFFFFFC00)

                                                                /* -------------------- Peripheral IDs -------------------- */
#define  AT91C_ID_SYS                   1
#define  AT91C_ID_US0                   7
#define  AT91C_ID_US1                   8
#define  AT91C_ID_US2                   9
...
#define  US2_CR             (*(CPU_INT32U *)(US2_BASE  + 0x0000))
#define  US2_MR             (*(CPU_INT32U *)(US2_BASE  + 0x0004))
#define  US2_IER            (*(CPU_INT32U *)(US2_BASE  + 0x0008))
#define  US2_IDR            (*(CPU_INT32U *)(US2_BASE  + 0x000C))
#define  US2_CSR            (*(CPU_INT32U *)(US2_BASE  + 0x0014))
#define  US2_RHR            (*(CPU_INT32U *)(US2_BASE  + 0x0018))
#define  US2_THR            (*(CPU_INT32U *)(US2_BASE  + 0x001C))
#define  US2_BRGR           (*(CPU_INT32U *)(US2_BASE  + 0x0020))
...
#define  PIOA_BSR           (*(CPU_INT32U *)(PIOA_BASE + 0x0074))
                                                                ...
                                                                /* ---------------- PIOC Register Defines ----------------- */
#define  PIOC_PDR           (*(CPU_INT32U *)(PIOC_BASE + 0x0004))
#define  PIOC_ASR           (*(CPU_INT32U *)(PIOC_BASE + 0x0070))
#define  PIOC_BSR           (*(CPU_INT32U *)(PIOC_BASE + 0x0074))

                                                                /* ---------------- PIOD Register Defines ----------------- */
#define  PIOD_PDR           (*(CPU_INT32U *)(PIOD_BASE + 0x0004))
#define  PIOD_ASR           (*(CPU_INT32U *)(PIOD_BASE + 0x0070))
#define  PIOD_BSR           (*(CPU_INT32U *)(PIOD_BASE + 0x0074))
...
*
* Note(s)     : (1) 'BSP_CPU_MclkFreq()' should return the Master Clock (MCK) frequency in Hz.
*********************************************************************************************************
*/

extern  CPU_INT32U  BSP_CPU_MclkFreq(void);
...
void  ProbeRS232_InitTarget (CPU_INT32U baud_rate)
{
    ...
    mclk_freq               = BSP_CPU_MclkFreq();               /* Calculate MCLK frequency                                 */

#if (PROBE_RS232_CFG_COMM_SEL == PROBE_RS232_UART_0)
                                                                /* ------------------ CONFIGURE US0 I/Os ------------------ */
                                                                /* Set GPIOA pins 26, 27, 28, & 29 as US0 pins              */
    PIOA_PDR              = DEF_BIT_26 | DEF_BIT_27 | DEF_BIT_28 | DEF_BIT_29;
    PIOA_ASR              = DEF_BIT_26 | DEF_BIT_27 | DEF_BIT_28 | DEF_BIT_29;
    ...
    PIOD_PDR              = DEF_BIT_00 | DEF_BIT_01;
    PIOD_ASR              = DEF_BIT_00 | DEF_BIT_01;
    ...
    PIOD_PDR              = DEF_BIT_02 | DEF_BIT_03;
    PIOD_ASR              = DEF_BIT_02 | DEF_BIT_03;
    ...
    PMC_PCER              = (1 << AT91C_ID_US2);                /* Enable the US2 peripheral clock                          */
                                                                ...
                                                                /* ----------------- CONFIGURE DBGU I/Os ------------------ */
                                                                /* Set GPIOC pins 30 & 31 as DBGU pins                      */
    PIOC_PDR  = DEF_BIT_30 | DEF_BIT_31;
    PIOC_ASR  = DEF_BIT_30 | DEF_BIT_31;
...
void  ProbeRS232_RxTxISRHandler (void)
{
    ...
    if ((US0_CSR  & AT91C_US_OVRE) == AT91C_US_OVRE) {
        US0_CSR = AT91C_US_RSTSTA;                              /* If an overrun occurs, reset the OR flag                  */
    }
    ...
    if ((US1_CSR  & AT91C_US_OVRE) == AT91C_US_OVRE) {
        US1_CSR = AT91C_US_RSTSTA;                              /* If an overrun occurs, reset the OR flag                  */
    }
    ...
    if ((US2_CSR  & AT91C_US_OVRE) == AT91C_US_OVRE) {
        US2_CSR = AT91C_US_RSTSTA;                              /* If an overrun occurs, reset the OR flag                  */
    }
    ...
    if ((DBGU_CSR  & AT91C_US_OVRE) == AT91C_US_OVRE) {
        DBGU_CSR = AT91C_US_RSTSTA;                             /* If an overrun occurs, reset the OR flag                  */
    }
#endif
}
