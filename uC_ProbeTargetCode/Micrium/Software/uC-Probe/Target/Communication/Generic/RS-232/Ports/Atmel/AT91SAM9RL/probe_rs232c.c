...
void  ProbeRS232_InitTarget (CPU_INT32U baud_rate)
{
    ...
    mclk_freq               = BSP_CPU_MclkFreq();               /* Calculate MCLK frequency                                 */
                                                                ...
                                                                /* ------------------ CONFIGURE US0 I/Os ------------------ */
                                                                /* Set GPIOA pins 6 & 7 as US0 pins                         */
    PIOA_PDR              = DEF_BIT_06 | DEF_BIT_07;
    PIOA_ASR              = DEF_BIT_06 | DEF_BIT_07;
    ...
    PMC_PCER              = (1 << AT91C_ID_US0);              /* Enable the US0 peripheral clock                          */
                                                                ...
                                                                /* ------------------ CONFIGURE US1 I/Os ------------------ */
                                                                /* Set GPIOA pins 11 & 12 as US1 pins                       */
    PIOA_PDR              = DEF_BIT_11 | DEF_BIT_12;
    PIOA_ASR              = DEF_BIT_11 | DEF_BIT_12;
    ...
    PMC_PCER              = (1 << AT91C_ID_US1);                /* Enable the US1 peripheral clock                          */
                                                                ...
                                                                /* ------------------ CONFIGURE US1 I/Os ------------------ */
                                                                /* Set GPIOA pins 13 & 14 as US2 pins                       */
    PIOA_PDR              = DEF_BIT_13 | DEF_BIT_14;
    PIOA_ASR              = DEF_BIT_13 | DEF_BIT_14;
    ...
    PMC_PCER              = (1 << AT91C_ID_US2);                /* Enable the US2 peripheral clock                          */
                                                                ...
                                                                /* ----------------- CONFIGURE DBGU I/Os ------------------ */
                                                                /* Set GPIOA pins 21 & 21 as DBGU pins                      */
