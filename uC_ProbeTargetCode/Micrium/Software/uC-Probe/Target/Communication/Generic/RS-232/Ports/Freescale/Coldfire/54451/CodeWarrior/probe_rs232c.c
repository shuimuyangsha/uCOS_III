...
*                                   Port for the Freescale CF54451
*
...
void  ProbeRS232_InitTarget (CPU_INT32U baud_rate)
{
    ...
    BSP_USART_Init(0, baud_rate);
                                                                        /* See APP_CFG.H                                            */
    MCF_INTC0_ICR(26) = MCF_INTC_ICR_LEVEL(PROBE_RS232_RX_TX_ISR_IP_IL);
                     
	CPU_VectSet(64 + 26, (void (*)(void))ProbeRS232_RxTxISR);           /* UART #0 Interrupt                                        */
    MCF_INTC0_IMRL &= ~MCF_INTC_IMRL_INT_MASK26;                        /* Unmask Tx & Rx interrupts                                */
#elif (PROBE_RS232_CFG_COMM_SEL == PROBE_RS232_UART_1)
    BSP_USART_Init(1, baud_rate);
                                                                        /* See APP_CFG.H                                            */
    MCF_INTC0_ICR(27) = MCF_INTC_ICR_LEVEL(PROBE_RS232_RX_TX_ISR_IP_IL);
                     
	CPU_VectSet(64 + 27, (void (*)(void))ProbeRS232_RxTxISR);           /* UART #1 Interrupt                                        */
    MCF_INTC0_IMRL &= ~MCF_INTC_IMRL_INT_MASK27;                        /* Unmask Tx & Rx interrupts                                */
#elif (PROBE_RS232_CFG_COMM_SEL == PROBE_RS232_UART_2)
    BSP_USART_Init(2, baud_rate);
                                                                        /* See APP_CFG.H                                            */
    MCF_INTC0_ICR(28) = MCF_INTC_ICR_LEVEL(PROBE_RS232_RX_TX_ISR_IP_IL);
                     
	CPU_VectSet(64 + 28, (void (*)(void))ProbeRS232_RxTxISR);           /* UART #2 Interrupt                                        */
    MCF_INTC0_IMRL &= ~MCF_INTC_IMRL_INT_MASK28;                        /* Unmask Tx & Rx interrupts                                */
#endif
}
