...
void  ProbeRS232_InitTarget (CPU_INT32U baud_rate)
{
    ...
    VICVectCntl(VIC_UART0)  =  14;                                      /* Set the vector priority                          */
    ...
    VICVectCntl(VIC_UART1)  =  14;                                      /* Set the vector priority                          */
    ...
    VICVectCntl(VIC_UART2)  =  14;                                      /* Set the vector priority                          */
    ...
    VICVectCntl(VIC_UART3)  =  14;                                      /* Set the vector priority                          */
