...
void  ProbeRS232_InitTarget (CPU_INT32U baud_rate)
{
    ...
    PROBE_RS232.SCR3.BIT.TIE   =  0;                                    /* Disable transmit interrupts                      */
    PROBE_RS232.SCR3.BIT.TE    =  0;                                    /* Disable transmitting                             */
    PROBE_RS232.SCR3.BIT.RIE   =  0;                                    /* Disable receive interrupts                       */
    PROBE_RS232.SCR3.BIT.RE    =  0;                                    /* Disable receiving                                */

    PROBE_RS232.SSR.BIT.FER    =  0;
    PROBE_RS232.SSR.BIT.PER    =  0;
    PROBE_RS232.SSR.BIT.OER    =  0;
    PROBE_RS232.SCR3.BIT.CKE   =  0;                                    /* Use internal clock, set SCK pin as input pin     */
    PROBE_RS232.SMR.BIT.COM    =  0;                                    /* Set for asynchronous mode                        */
    ...
    ProbeRS232_Config();
    BSP_Dly(1);
    PROBE_RS232.SCR3.BIT.TE    =  1;                                    /* Enable transmitting                              */
    PROBE_RS232.SCR3.BIT.TIE   =  0;                                    /* Enable Transmit Interrupts                       */
    PROBE_RS232.SCR3.BIT.RE    =  1;                                    /* Enable receiving                                 */
    PROBE_RS232.SCR3.BIT.RIE   =  0;                                    /* Enable Receive Interrupts                        */
}

void  ProbeRS232_EnSCIF (void)
{
    MSTCR1.BIT.MSTS3 = 0;                                               /* Enable SCIF1 module                              */
}

void  ProbeRS232_Config (void)
{
    IO.PMR1.BIT.TXD = 1;                                                /* Set the data direction register                  */
}
...
{
    PROBE_RS232.SCR3.BIT.RIE = 0;                                        /* Enable receiving                                 */
}
...
{
    PROBE_RS232.SCR3.BIT.RIE = 1;                                        /* Enable Transmit Interrupts                       */
}
...
{
    PROBE_RS232.SCR3.BIT.TIE = 1;                                        /* Enable Transmit Interrupts                       */
}
...
void ProbeRS232_EriISRHandler (void)
{
    ...
    if (PROBE_RS232.SSR.BIT.OER == 1) {
        PROBE_RS232.SSR.BIT.OER  = 0;
        (void)PROBE_RS232.SSR.BIT.OER;
    }
